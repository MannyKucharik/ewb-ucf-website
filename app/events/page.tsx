          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="relative h-48">
                  ...
                  <div className="absolute bottom-0 left-0 p-4">
                    <div className="text-white text-sm font-medium mb-1">TBA</div>
                    <h3 className="text-white text-xl font-bold">Coming Soon</h3>
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-gray-600 mb-4">
                    Stay tuned for new events on the horizon!                  </p>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4">
                    Stay tuned for new events on the horizon!
                  </p>
                  <div className="flex items-start space-x-2 text-gray-600 mb-4">
                    <svg className="w-5 h-5 text-blue-700 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
